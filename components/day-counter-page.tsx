...
import { Calendar, Code2, Globe, Menu, Shield, Wrench, ShoppingCart, MessageCircle } from 'lucide-react';
      ...
      <section className="w-full px-4 py-10 md:py-16 max-w-4xl mx-auto">
        <div className="glass-card rounded-2xl border border-white/10 bg-white/5 p-5 md:p-8 space-y-5 md:space-y-6">
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground text-sm md:text-base leading-relaxed">{t.dayCounterSubtitle}</p>
          </div>
